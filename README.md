...
- **项目依赖：**`compile 'com.vise.xiaoyaoyou:baseble:2.0.1'`
...
## 版本说明
[![LatestVersion](https://img.shields.io/badge/LatestVersion-2.0.1-orange.svg)](https://github.com/xiaoyaoyou1212/BLE/blob/master/VERSION.md)

## 代码托管
[![JCenter](https://img.shields.io/badge/JCenter-2.0.1-orange.svg)](https://jcenter.bintray.com/com/vise/xiaoyaoyou/baseble/2.0.1/)
...
```
compile 'com.vise.xiaoyaoyou:baseble:2.0.1'
```
构建完后就可以直接使用该库的功能了。
